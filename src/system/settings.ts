...
export enum Setting {
  ...
  Vibration = "VIBRATION",
  Additional_Battle_Info = "Additional Battle Information"
}
...
export const settingOptions: SettingOptions = {
  ...
  [Setting.Additional_Battle_Info]: ["Off", "On"]
};
...
export const settingDefaults: SettingDefaults = {
  ...
  [Setting.Vibration]: 0,
  [Setting.Additional_Battle_Info]: 0
};
...
export function setSetting(scene: BattleScene, setting: Setting, value: integer): boolean {
  ...
  case Setting.Vibration:
    ...
    break;
  case Setting.Additional_Battle_Info:
    scene.additionalBattleInfo = settingOptions[setting][value] === "On";
    break;
